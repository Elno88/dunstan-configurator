                ...
                <div class="boxed">
                    <table class="table-resultat">
                        <tr>
                            ...
                            <td>Olycksfallsförsäkring</td>
                        </tr>
                        <tr>
                            <th>Startdatum</th>
                            <td>
                                <div class="editinplace">
                                    <input type="text" class="edit" value="{{ $date ?? null }}" name="startdatum" placeholder="0000-00-00">
                                </div>
                            </td>
                        </tr>
                    </table>
                ...
                <div class="boxed">
                    <table class="table-resultat">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="editinplace">
                                    <input type="text" class="edit" value="{{ $customer['kund']['email'] ?? $email ?? '' }}" name="email" placeholder="Ange din epost">
                                </div>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <div class="editinplace">
                                    <input type="tel" class="edit" value="{{ $customer['kund']['telefon'] ?? $phone ?? '' }}" name="telefon" placeholder="Ange ditt mobilnummer">
                                </div>
                            </td>
                        </tr>
                    </table>
...
<script type="text/javascript">
    function updatePrice() {
        let data = {
            'date': '{{ $date }}',
            'betalningstermin': $('input[name=betalningstermin]:checked').val(),
        };
    ...
    function validate_step($button) {
        ...
        $.ajax({
            type: 'post',
            url: '/step/olycksfallsforsakring-sammanfattning',
            cache: false,
            dataType: 'json',
            data: data,
            beforeSend: function () {
    ...
    function bankid_status(orderRef, $button, buttonOriginalText, force_retries) {
        $.ajax({
            type: 'post',
            url: '/step/olycksfallsforsakring-sammanfattning/bankid_status',
            cache: false,
            headers: {
    ...
    function bankid_sign($button, buttonOriginalText) {
        ...
        $.ajax({
            type: 'post',
            url: '/step/olycksfallsforsakring-sammanfattning/bankid_sign',
            cache: false,
            headers: {
                'cache-control': 'no-cache'
            },
