    ...
    <div class="frame-contents">
        ...
        <div class="frame-resultat" data-horseusage="{{ $horse_usage ?? '0' }}">
			...
			@endif
                ...
                <!-- Avel / Breeding
                <div class="resultat-select-caption @if(isset($defaults['veterinarvardsforsakring']) && $defaults['veterinarvardsforsakring'] == 7){{ 'active' }}@endif" data-content="vvf-7" data-type="vet">
